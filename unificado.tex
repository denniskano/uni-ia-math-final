...
\begin{document}
        ...
        \hangindent=0.5in \hangafter=1 Emioma, A., \& Edeki, S. (2020). BBCA stock price prediction using linear regression method. \textit{International Journal of Computer Applications, 176}(20), 1–6. https://doi.org/10.5120/ijca2020920162\par
        \hangindent=0.5in \hangafter=1 Faber, V., \& Faber, S. (2016). \textit{Linear Algebra: Concepts and Methods}. Cambridge University Press.\par
        \hangindent=0.5in \hangafter=1 Golub, G. H., \& Van Loan, C. F. (2013). \textit{Matrix Computations} (4th ed.). Johns Hopkins University Press.\par
        \hangindent=0.5in \hangafter=1 Hastie, T., Tibshirani, R., \& Friedman, J. (2009). \textit{The Elements of Statistical Learning: Data Mining, Inference, and Prediction} (2nd ed.). Springer.\par
        \hangindent=0.5in \hangafter=1 Hastie, T., Tibshirani, R., \& Friedman, J. (2017). \textit{The Elements of Statistical Learning: Data Mining, Inference, and Prediction} (2nd ed.). Springer.\par
        ...
        \hangindent=0.5in \hangafter=1 Liu et al. (2020). \textit{PCA reveals the underlying patterns of RNA-Seq data in cancer studies}. En \textit{Nature Communications} \par
        ...
        \hangindent=0.5in \hangafter=1 Markovsky, I., \& Van Huffel, S. (2011). \textit{Introduction to Total Least Squares}. SIAM.\par
        \hangindent=0.5in \hangafter=1 Miller, S. J. (2006). The method of least squares. Williams College.\par
        \hangindent=0.5in \hangafter=1 Minka, T. P. (2001). Expectation propagation for approximate Bayesian inference. En \textit{Proceedings of the Seventeenth Conference on Uncertainty in Artificial Intelligence} (pp. 362–369). Morgan Kaufmann Publishers Inc.\par
        \hangindent=0.5in \hangafter=1 Minka, T. P. (2005). Divergence measures and message passing. En \textit{Proceedings of the 2005 IEEE International Symposium on Information Theory} (pp. 205–209). IEEE.\par
        \hangindent=0.5in \hangafter=1 Samrudhi, K. (2021). A Model Based Linear Algebraic Approach for Machine Learning. \textit{6th International Conference for Convergence in Technology} \par
        ...
        \hangindent=0.5in \hangafter=1 Zhao et al. (2021). \textit{PCA-enhanced Raman spectroscopy for defect analysis in graphene}. Advanced Materials Interfaces.\par
